...
public class FabricJavaTest {
    ...
    private static User getFabricUser4Local(String username, String org, String orgId) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
        ...
        FabricUsersImpl user = new FabricUsersImpl(username, org);
            ...
            String certificate = new String(IOUtils.toByteArray(new FileInputStream(new File("/project/opt_fabric/fabricconfig/crypto-config/peerOrganizations/org1.robertfabrictest.com/users/Admin@org1.robertfabrictest.com/msp/signcerts/Admin@org1.robertfabrictest.com-cert.pem"))), "UTF-8");
            ...
            File privatekeyfile = new File("/project/opt_fabric/fabricconfig/crypto-config/peerOrganizations/org1.robertfabrictest.com/users/Admin@org1.robertfabrictest.com/msp/keystore/b031338f76290f089d330b064d4534202a49ae8d65ca5d266c377bc46812a884_sk");
